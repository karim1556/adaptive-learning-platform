  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col h-full">
      ...
      <div className="p-6 border-b border-slate-100 dark:border-slate-800">
        <Link href="/teacher/dashboard" className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="block text-xs text-slate-500">Teacher Portal</span>
          </div>
        </Link>
      </div>
      ...
      <div className="px-4 py-4">
        <Link href="/teacher/classes?create=true">
          <button className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-medium transition">
            ...
            <Link key={item.href} href={item.href}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className={cn("text-xs truncate", isActive ? "text-indigo-100" : "text-slate-500")}>
                    {item.description}
                  </div>
                </div>
